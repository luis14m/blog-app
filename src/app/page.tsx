            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Crea publicaciones detalladas con nuestro editor intuitivo.
                    Da formato al texto, añade imágenes, PDFs y más.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Participa en discusiones técnicas detalladas. Adjunta
                    archivos, comparte especificaciones y mantén conversaciones
                    profesionales.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Construye tu presencia profesional con perfiles
                    personalizables. Muestra tus proyectos y seguimiento de
                    contribuciones.
                  </p>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 mt-8 md:grid-cols-2 lg:grid-cols-3">
              {latestPosts && latestPosts.length > 0 ? (
                ...
                <div className="col-span-3 text-center py-12">
                  <p className="text-muted-foreground">
                    Aún no hay posts publicados. ¡Sé el primero en compartir
                    uno!
                  </p>
                </div>
              )}
            ...
            <div className="flex justify-center mt-8">
              <Button asChild variant="outline">
                <Link href="/blog">Ver todos los Post</Link>
              </Button>
            </div>
          </div>
        </section>
